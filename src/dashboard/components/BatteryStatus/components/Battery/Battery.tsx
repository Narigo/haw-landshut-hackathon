...
export default class Battery extends PresentationComponent<BatteryProps, {}> {
  public render() {
    ...
    const batteryInlineStyles = {
      ...
      borderImage: `background-image,linear-gradient(to right, transparent 5%, ${colorRange[0]} 5%, ${colorRange[0]} 7%, ${colorRange[1]} 8%, ${colorRange[1]} 10%, ${colorRange[2]} 11%, ${colorRange[2]}${charge -
